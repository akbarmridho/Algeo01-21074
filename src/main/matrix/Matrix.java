...
public class Matrix {
     ...
     */
    public Matrix getAdjoint() throws NotMatrixSquareException {
        if(!this.isSquare())
        {
            throw new NotMatrixSquareException("Matriks bukan persegi sehingga tidak bisa diperoleh adjoint");
        }
